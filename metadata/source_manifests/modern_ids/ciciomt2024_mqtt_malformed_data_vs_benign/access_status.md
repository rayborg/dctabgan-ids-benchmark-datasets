# Access Status: ciciomt2024_mqtt_malformed_data_vs_benign
...
- `data/staging/modern_ids_audit/CICIoMT2024/data/MQTT-Malformed_Data_train.pcap_Flow.csv`: 1996 rows, 961698 bytes.

## Materialized Split

- Ratio floor: `17` for `Benign`:`MQTT Malformed Data`.
- Train total: `9000`, with `8500` Benign and `500` MQTT Malformed Data.
- Test total: `9000`, with `8500` Benign and `500` MQTT Malformed Data.
